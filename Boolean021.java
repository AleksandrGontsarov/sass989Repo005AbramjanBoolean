...
// Возрастающая последовательность – если каждый
// следующий элемент этой последовательности превышает предыдущий.

public class Boolean021 {
...
//        int third = (a - a % 100) / 100; // третий порядок
        ...
        System.out.println("Образуют возрастающую последовательность : " + result);
    }
}